...
import fragmentShader from './shaders/springs/fragment-shader.glsl';
import vertexShader from './shaders/springs/vertex-shader.glsl';
...
export default class CustomSpringsLayer extends Layer {
    ...
    getTextureCoordinates(positionsBuffer){ 
        ...
        for(let i = 0; i < textureCoordBuffer.length; i+=8){
            ...
            let textureSize = vectorSize/this.props.springLength;
    ...
    updateState({oldProps, props, changeFlags}) {
        ...
        if(changeFlags.dataChanged) {
            ...
            const textureCoordBuffer = this.getTextureCoordinates(positionsBuffer);
        ...
        if(props.springLength !== oldProps.springLength){   
            const textureCoordBuffer = this.getTextureCoordinates(this.state.positionsBuffer);
            this.setState({
                textureCoordBuffer: textureCoordBuffer,
            });
        }
